import {
  NG_VALUE_ACCESSOR
} from "./chunk-DFA4UDMB.js";
import {
  CommonModule,
  DOCUMENT,
  NgIf
} from "./chunk-QU63XZ75.js";
import {
...
_NuLazyService.ɵfac = function NuLazyService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NuLazyService)(ɵɵinject(DOCUMENT));
};
_NuLazyService.ɵprov = ɵɵdefineInjectable({
  token: _NuLazyService,
  factory: _NuLazyService.ɵfac,
  providedIn: "root"
});
var NuLazyService = _NuLazyService;
(() => {
...
var _TinymceComponent = class _TinymceComponent {
  set disabled(value) {
...
_TinymceComponent.ɵfac = function TinymceComponent_Factory(__ngFactoryType__) {
...
_TinymceComponent.ɵcmp = ɵɵdefineComponent({
...
var TinymceComponent = _TinymceComponent;
(() => {
...
var _NgxTinymceModule = class _NgxTinymceModule {
...
_NgxTinymceModule.ɵfac = function NgxTinymceModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxTinymceModule)();
};
_NgxTinymceModule.ɵmod = ɵɵdefineNgModule({
  type: _NgxTinymceModule,
  imports: [CommonModule, TinymceComponent],
  exports: [TinymceComponent]
});
_NgxTinymceModule.ɵinj = ɵɵdefineInjector({
  imports: [CommonModule]
});
var NgxTinymceModule = _NgxTinymceModule;
(() => {
